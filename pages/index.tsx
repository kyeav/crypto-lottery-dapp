...
const Home: NextPage = () => {
  ...
  const { isLoading, contract } = useContract(
    process.env.NEXT_PUBLIC_LOTTERY_CONTRACT_ADDRESS
  );
  const [quantity, setQuantity] = useState<number>(1);
  const [userTickets, setUserTickets] = useState(0);
  // const { contract } = useContract("0xB771dF889e678ab9d1D38EcC00fF58A6Ca221F17");
  ...
  // const call = async () => {
  //   try {
  //     const data = await BuyTickets([ {{args}} ]);
  ...
  const handleClick = async () => {
    ...
    const notif = toast.loading("Buying your tickets...");
  ...
  return (
    <div className="bg-[#091b18] min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {winnings > 0 && (
          <div className="max-w-md mg:max-w-2xl lg:max-w-4xl mx-auto mt-5">
            <button
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-between p-5">
        ...
        <p className="text-xs text-emerald-900 pl-5">
          DISCLAIMER: Online gambling, even with bitcoin, is illegal in many
          countries and jurisdictions. It is your responsibility to ensure that
          online gambling is legal in your jurisdiction. Crypto Draw does not
          accept responsibility for any errors on this website and we do not
          accept liability for any financial losses incurred as a result of
          using this website.
        </p>
      </footer>
    </div>
